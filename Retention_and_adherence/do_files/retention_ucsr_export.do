...
**************************************************************************
**************************************************************************
** Do file for export of Retention and adherence studies to the UCSR, using select variables
** Lily Alexander
...
set more off 
	...
	*Lily's temporary path: 
	cd "/Users/lilyalexander/Dropbox/ALL LIFE THINGS/INSP/Work with Sergio/GHCC/Post-Extraction-Processing/Retention_and_adherence/wide_files"
	use retention_wide_file_Apr2018.dta, replace
...
** Begin by selecting key variables for export
	...
	*/
		...
		* Label remaining confusing variables
		...
		label var a_prisd_rc_counseling "Primary SD: R&C Counseling (A)"
...
local to_decode "disease collapsed output_unit2 pop_density ownership platform facility_cat id_class id_type id_int id_phase method id_tech pop_sex tb_rx_resistance timing country_sampling geo_sampling_incountry site_sampling px_sampling sample_size_derived controls econ_perspective_actual econ_costing real_world asd_costs sensitivity_analysis scale research_costs unrelated_costs overhead volunteer_time family_time px_costs_measured cat_cost iso_code currency_iso currency_x inflation" 
...
foreach var of local to_decode { 
	...
	replace `var' = subinstr(`var', "Sms", "SMS", .)
...
a_primary_sd a_prisd_rc_counseling a_secondary_sd a_ancillary /// 
a_anc_demand_generation a_anc_lab_services a_anc_adhreten a_anc_unspecified /// 
a_operational a_ope_bldg_equip a_ope_logistics a_ope_program_mgmt a_ope_supervision a_ope_training a_ope_transportation a_ope_massed a_ope_hmis a_ope_technology_development a_ope_unspecified a_mixed
...
* Finally, export!
**************************
save Retention_and_adherence_clean_wide_file_Apr2018.dta, replace
