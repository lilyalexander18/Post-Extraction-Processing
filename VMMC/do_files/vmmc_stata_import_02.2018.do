...
***********************
	...
	cd "/Users/lilyalexander/Dropbox/ALL LIFE THINGS/INSP/Work with Sergio/GHCC/Post-Extraction-Processing/VMMC/"
	
* 1: Load in both data files (change title of excel file as appropriate)
***********************

* Costs data sheet
	import excel extraction_templates/GHCC_Data_Extraction_VMMC_19-Apr-2018_derived_from_final.xlsx, firstrow sh("Cost data") cellrange(A4) case(l)
...
* Study Attributes data sheet	
	import excel extraction_templates/GHCC_Data_Extraction_VMMC_19-Apr-2018_derived_from_final.xlsx, firstrow sh("Study attributes") cellrange(A4) case(l)
...
* First change directory to pull up generic inflation do file
	...
	*GDP Deflator
	 run do_files/inflation_methods/inflation_vmmc_gdp.do
...
use temp_dta/costs.dta
			...
			*********************************************
				...
				*clean up
				foreach i of varlist cap_medical_equip-uns_unspecified {
					replace `i'=. if `i'==0
				}
	...
	* First set up the desired order of the collapsed cost variable with markers
		...
		************************************************************************************
			...
			********************************************
			...
			save "/Users/lilyalexander/Dropbox/ALL LIFE THINGS/INSP/Work with Sergio/GHCC/Post-Extraction-Processing/VMMC/wide_files/VMMC_wide_file_Apr2018.dta", replace
