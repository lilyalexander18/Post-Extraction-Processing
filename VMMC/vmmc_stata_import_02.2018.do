...
* Costs data sheet
	import excel extraction_templates/GHCC_Data_Extraction_VMMC_6-Feb-2018.xlsx, firstrow sh("Cost data") cellrange(A4) case(l)
...
* Study Attributes data sheet	
	import excel extraction_templates/GHCC_Data_Extraction_VMMC_6-Feb-2018.xlsx, firstrow sh("Study attributes") cellrange(A4) case(l)
