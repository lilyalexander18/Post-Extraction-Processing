...
set more off 
	...
	*Lily's temporary path: 
	cd "/Users/lilyalexander/Dropbox/ALL LIFE THINGS/INSP/Work with Sergio/GHCC/Post-Extraction-Processing/HCT/wide_files" 
	use hct_wide_file_Apr2018.dta, replace
...
**********************************
	...
	****************************************************************
	egen check = rowtotal(si_capital si_recurrent si_mixed si_personnel si_unspecified)
	...
	************************************************************************
	...
	local prefix "rec per cap uns mix" 
	...
	**********************************************************
	...
	egen check = rowtotal(a_primary_sd a_operational a_ancillary a_mixed a_unspecified)
	gen diff = check - mean_cost
	gen flag = 1 if diff > 1
	...
	******************************************************************
	...
	local prefix "prisd anc ope uns mix" 
	...
	gen diff_mix = sum_mix - a_unspecified
...
local to_decode "disease output_unit2 pop_density ownership platform facility_cat id_class id_int id_type id_phase method id_tech pop_sex tb_rx_resistance timing country_sampling geo_sampling_incountry site_sampling px_sampling sample_size_derived controls econ_perspective_actual econ_costing real_world asd_costs sensitivity_analysis scale research_costs unrelated_costs overhead volunteer_time family_time px_costs_measured cat_cost iso_code currency_iso currency_x inflation" 
...
foreach var of varlist clinical_monitoring demand_generation counseling_content staff_type supportive_care community_awareness visits referrals id_activities list_asd_cost overhead_costs id_tech_det { 
...
* Finally, export!
**************************
save HCT_clean_wide_file_Apr2018.dta, replace
