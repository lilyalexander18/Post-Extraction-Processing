...
* Costs data sheet
	import excel GHCC_Data_Extraction_VMMC_v54_16-June-2017, firstrow sh("Cost data") cellrange(A3) case(l)
...
* Study Attributes data sheet	
	import excel GHCC_Data_Extraction_VMMC_v54_16-June-2017, firstrow sh("Study attributes") cellrange(A3) case(l)
...
*************************************
	...
	*First concatinate cost level data into unit_cost level observations
		gen _="_"
		gen unit_cost1=substudyid+_+unit_cost
